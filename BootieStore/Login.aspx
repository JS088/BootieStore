<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BootieStore.Login" %>
...
<body>
            ...
            <div class="container-fluid px-lg-5">
                ...
                <nav class="py-4">
                    ...
                    <ul class="menu mt-2">
                        ...
                        <li class="active"><a href="Contact.aspx">Coantact</a></li>
                    </ul>
                </nav>
                <!-- //nav -->
            </div>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-3">
            <h3 class="tittle text-center"><span class="sub-tittle">Find Us</span>Admin Login</h3>
            <div class="row contact-main-info mt-5">
                <div class="col-md-6 contact-right-content">
                   
                        
                        <asp:TextBox ID="txtEmail" TextMode="Email" runat="server" placeholder="Email" required=""></asp:TextBox>
                        <asp:TextBox ID="txtPassword"   runat="server" placeholder="Passwprd" required=""></asp:TextBox>
