<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="BootieStore.Product" %>
...
<body>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-3">
            <h3 class="tittle text-center"><span class="sub-tittle">Find Us</span>Add Product</h3>
            <div class="row contact-main-info mt-5">
                <div class="col-md-6 contact-right-content">
                   
                        
                        <asp:TextBox ID="txtName" runat="server" placeholder="ProductName" required=""></asp:TextBox>
                        <asp:TextBox ID="txtCategory"  runat="server" placeholder="Category Like Men/Women" required=""></asp:TextBox>
                        <asp:TextBox ID="TxtPrice"  runat="server" placeholder="Price" required=""></asp:TextBox>

                        <asp:FileUpload ID="FileUpload1" runat="server"  />

                        
                        <div class="read mt-3">
                            <asp:Button ID="Login" runat="server" Text="Add Product" OnClick="Login_Click" />    
                        </div>
                    <h3 id="data" runat="server"></h3>
                </div>
