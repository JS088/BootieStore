<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="BootieStore.Contact" %>
            ...
            <div class="row contact-main-info mt-5">
                <div class="col-md-6 contact-right-content">
                       ...
                       <asp:TextBox ID="txtEmail" TextMode="Email" runat="server" placeholder="Email" required=""></asp:TextBox>
                        <asp:TextBox ID="txtContact"  runat="server" placeholder="Phone" required=""></asp:TextBox>
                        <asp:TextBox ID="txtMsg" TextMode="MultiLine" runat="server" placeholder="Msg" required=""></asp:TextBox>
                        
                        
                        <div class="read mt-3">
                            <asp:Button ID="msg" runat="server" Text="Send Message" OnClick="msg_Click" />    
                        </div>
