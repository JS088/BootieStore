<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedBack.aspx.cs" Inherits="BootieStore.FeedBack" %>
        ...
        <div class="container py-3">
            ...
            <div class="row contact-main-info mt-5">
                <div class="col-md-12 contact-right-content">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BootieStoreConnectionString3 %>" DeleteCommand="DELETE FROM [Contact] WHERE [id] = @id" InsertCommand="INSERT INTO [Contact] ([Name], [Email], [Phone], [msg]) VALUES (@Name, @Email, @Phone, @msg)" SelectCommand="SELECT * FROM [Contact] ORDER BY [id] DESC" UpdateCommand="UPDATE [Contact] SET [Name] = @Name, [Email] = @Email, [Phone] = @Phone, [msg] = @msg WHERE [id] = @id">
                        <DeleteParameters>
